...
//import com.example.weatherprod.Model.Condition
//import com.example.weatherprod.Model.Forecast
//import com.example.weatherprod.Model.ForecastDay
//import com.example.weatherprod.Model.WeatherDTO
//import com.example.weatherprod.WService
//import com.example.weatherprod.WeatherApiInterceptorKey
...
//
//
//    val weather: MutableLiveData<WeatherDTO?> = MutableLiveData()
//    val weeklyWeather: MutableLiveData<List<ForecastDay>?> = MutableLiveData()
//
...
//        .build()
//
//    private val apiCall = retrofit.create(WService::class.java)
//
//    fun getWeather(city: String) {
//        apiCall.getCurrentWeatherByCity(city).enqueue(object : Callback<WeatherDTO> {
...
//        })
//
//        apiCall.getDailyWeather(city).enqueue(object : Callback<WeatherDTO> {
//            override fun onResponse(call: Call<WeatherDTO>, response: Response<WeatherDTO>) {
//                val data = response.body()
//                weeklyWeather.value = data?.forecast?.forecastDay
//            }
//
//            override fun onFailure(call: Call<WeatherDTO>, t: Throwable) {
//                // Обработка ошибки
...
//
//
//            else -> R.drawable.feelslike// Иконка по умолчанию
//
//
//        }
//    }
